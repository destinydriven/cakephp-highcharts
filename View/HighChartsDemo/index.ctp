...
<table>
	...
	<tbody>
		<tr>
			...
			<td><?php echo $this->Html->link('Column', array('plugin' => 'high_charts', 'controller' => 'minimalist_demo', 'action' => 'column')); ?></td>
		...
		<tr>
			...
			<td><?php echo $this->Html->link('Pie', array('plugin' => 'high_charts', 'controller' => 'minimalist_demo', 'action' => 'pie')); ?></td>
		...
		<tr>
			...
			<td><?php echo $this->Html->link('Column with Rotated Label', array('plugin' => 'high_charts', 'controller' => 'minimalist_demo', 'action' => 'column_rotated')); ?></td>
			<td></td>
			<td></td>
		</tr>
		<tr>
			...
			<td><?php echo $this->Html->link('Spline with Crosshairs', array('plugin' => 'high_charts', 'controller' => 'minimalist_demo', 'action' => 'spline_cross')); ?></td>
			<td></td>
			<td></td>
		</tr>
		<tr>
			...
			<td></td>
			<td><?php echo $this->Html->link('Line with Data Labels', array('plugin' => 'high_charts', 'controller' => 'minimalist_demo', 'action' => 'line')); ?></td>
			<td></td>
			<td></td>
		</tr>
		<tr>
